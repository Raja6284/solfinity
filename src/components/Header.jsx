      ...
      <div className="container mx-auto flex flex-col md:flex-row md:items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <nav className="flex space-x-6">
            <Link
              to="/airdrop"
              className={`hover:text-blue-400 transition py-2 border-b-2 ${
                location.pathname === "/airdrop" ? "border-blue-500 text-blue-400" : "border-transparent"
              }`}
            >
              Request Airdrop
            </Link>
            <Link
              to="/create-token"
              className={`hover:text-blue-400 transition py-2 border-b-2 ${
                location.pathname === "/create-token" ? "border-blue-500 text-blue-400" : "border-transparent"
              }`}
            >
              Create Token
            </Link>
            <Link
              to="/create-liquidity"
              className={`hover:text-blue-400 transition py-2 border-b-2 ${
                location.pathname === "/create-liquidity" ? "border-blue-500 text-blue-400" : "border-transparent"
              }`}
            >
              Create Liquidity
            </Link>
            <Link
              to="/my-tokens"
              className={`hover:text-blue-400 transition py-2 border-b-2 ${
                location.pathname === "/my-tokens" ? "border-blue-500 text-blue-400" : "border-transparent"
              }`}
            >
              My Tokens
            </Link>
          ...
          <nav className="flex flex-col">
            <Link
              ...
              className={`px-4 py-3 hover:bg-gray-700 transition ${
                location.pathname === "/airdrop" ? "bg-gray-700 text-blue-400" : ""
              }`}
            >
              Request Airdrop
            </Link>
            <Link
              to="/create-token"
              className={`px-4 py-3 hover:bg-gray-700 transition ${
                location.pathname === "/create-token" ? "bg-gray-700 text-blue-400" : ""
              }`}
            >
              Create Token
            </Link>
            <Link
              to="/create-liquidity"
              className={`px-4 py-3 hover:bg-gray-700 transition ${
                location.pathname === "/create-liquidity" ? "bg-gray-700 text-blue-400" : ""
              }`}
            >
              Create Liquidity
            </Link>
            <Link
              to="/my-tokens"
              className={`px-4 py-3 hover:bg-gray-700 transition ${
                location.pathname === "/my-tokens" ? "bg-gray-700 text-blue-400" : ""
              }`}
            >
              My Tokens
            </Link>
